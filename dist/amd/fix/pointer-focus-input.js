(/* istanbul ignore next */ function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(module, exports, require('../get/focus-target'), require('../util/decorate-context'), require('../util/element-matches'), require('../util/platform'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.focusTarget, global.decorateContext, global.elementMatches, global.platform);
    global.pointerFocusInput = mod.exports;
  }
})(this, function (module, exports, _focusTarget, _decorateContext, _elementMatches, _platform) {
  'use strict';

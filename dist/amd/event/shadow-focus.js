(/* istanbul ignore next */ function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(module, exports, require('../get/active-elements'), require('../util/decorate-service'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.activeElements, global.decorateService);
    global.shadowFocus = mod.exports;
  }
})(this, function (module, exports, _activeElements, _decorateService) {
  'use strict';
